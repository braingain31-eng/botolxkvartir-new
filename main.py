...
if __name__ == "__main__":
    ...
    # Запуск с использованием asyncio для поддержки асинхронных функций Flask
    # requires 'pip install flask[async]' or 'pip install uvicorn' for production
    # Используем app.run для простоты, но лучше использовать uvicorn/gunicorn в проде
